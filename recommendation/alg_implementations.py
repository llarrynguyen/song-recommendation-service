...
def get_utility_score(M, group_utility, disagreement, w):
    ...
    pref = utils.get_function_switch(
        group_utility, constants.GROUP_UTILITY_SWITCH)
    dis = utils.get_function_switch(
        disagreement, constants.DISAGREEMENT_SWITCH)
...
diversify_group_recommendation_the_algorithm(
    "databases/parsed-databases/movie-lenz.csv", 5)
